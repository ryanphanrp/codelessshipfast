    ...
    <div className={cn("container mx-auto max-w-7xl space-y-6 p-6", className)}>
      ...
      <div className="flex flex-wrap gap-2">
        ...
        <Button
          size="sm"
          variant="outline"
          onClick={() => handleConvert("interface")}
        >
          Convert Interface
        </Button>
        <Button
          size="sm"
          variant="outline"
          onClick={() => handleConvert("standardize")}
        >
          Standardize
        </Button>
        <Button
      ...
      <div className="grid min-h-[600px] grid-cols-1 lg:grid-cols-2">
        <Card className="flex flex-col border-none p-0 bg-white ">
          <CardContent className="flex-1 p-0">
            <div className="flex h-full flex-col space-y-2">
              <label className="font-medium mb-0 bg-primary text-white py-2 pl-2 text-sm">
                Java Record Input
              </label>
              <Textarea
                placeholder="Enter Java 17 record class..."
                value={javaCode}
                className="min-h-[500px] border border-primary flex-1 font-mono text-sm"
