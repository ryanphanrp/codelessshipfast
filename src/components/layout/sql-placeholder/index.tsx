			...
			<Card className="border-none shadow-none">
				...
				<CardFooter>
					<div className="flex flex-wrap gap-2">
						<Button size="xs" className="cursor-pointer px-6" onClick={handlePasteFromClipboard}>
							Paste then fill SQL
						</Button>
						<Button size="xs" className="cursor-pointer px-6" variant="outline" onClick={fillQuery}>
							Fill SQL Query
						</Button>
					</div>
				</CardFooter>
