...
const Dashboard = () => {
  return (
    <div className="container mx-auto max-w-7xl space-y-8 p-6">
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
        {quickActions.map((action) => (
          <Link key={action.href} href={action.href}>
            <Card className="group h-full border-2 border-primary transition-all hover:border-primary/50">
            ...
            <div className="space-y-3">
              {recentTools.map((tool, index) => (
                ...
                >
                  ...
                  <Badge
                    variant={
                      tool.status === "success" ? "secondary" : "destructive"
                    }
      ...
      {/* Quick Tips */}
      <Card className="border-2 border-primary bg-gradient-to-br from-background to-accent/20">
        <CardHeader>
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <div className="space-y-2">
              ...
              <p className="text-muted-foreground text-sm leading-relaxed">
                Use{" "}
                <kbd className=" border border-border bg-muted px-1.5 py-0.5 font-mono text-xs">
                  Ctrl+V
                </kbd>{" "}
                to paste directly into any tool. Results are automatically
                copied to clipboard.
              </p>
            </div>
            <div className="space-y-2">
              ...
              <p className="text-muted-foreground text-sm leading-relaxed">
                Toggle between light and dark themes using the sidebar.
